...
function index()
	...
	entry({"admin", "services", "frp"}, alias("admin", "services", "frp", "base"), _("MultiFrpc内网穿透"), 100).dependent = true
	entry({"admin", "services", "frp", "base"}, cbi("frp/basic"), _("Multi Frp 内网穿透"), 1).leaf = true
